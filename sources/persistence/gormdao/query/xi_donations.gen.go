...
func newDonation(db *gorm.DB, opts ...gen.DOOption) donation {
	...
	_donation.UserEntity = donationBelongsToUserEntity{
		...
		Personalizations: struct {
			...
			RelationField: field.NewRelation("UserEntity.Personalizations", "entities.Personalization"),
			User: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("UserEntity.Personalizations.User", "entities.User"),
			},
		},
		Usages: struct {
			field.RelationField
