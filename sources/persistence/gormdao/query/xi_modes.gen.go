		...
		Mode: struct {
			...
			Creator: struct {
				...
				Personalizations: struct {
					...
					RelationField: field.NewRelation("SelectedModes.Mode.Creator.Personalizations", "entities.Personalization"),
					User: struct {
						field.RelationField
					}{
						RelationField: field.NewRelation("SelectedModes.Mode.Creator.Personalizations.User", "entities.User"),
					},
				},
				Usages: struct {
					field.RelationField
					...
					RelationField: field.NewRelation("SelectedModes.Mode.Creator.Usages", "entities.Usage"),
					User: struct {
						field.RelationField
					}{
						RelationField: field.NewRelation("SelectedModes.Mode.Creator.Usages.User", "entities.User"),
					},
				},
				Bans: struct {
					field.RelationField
					...
					RelationField: field.NewRelation("SelectedModes.Mode.Creator.Bans", "entities.Ban"),
					User: struct {
						field.RelationField
					}{
						RelationField: field.NewRelation("SelectedModes.Mode.Creator.Bans.User", "entities.User"),
					},
				},
			},
			SelectedModes: struct {
